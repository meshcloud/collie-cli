    ...
    return Promise.resolve([
        {
          ...
          "principalType": "Group",
          "roleDefinitionId": "/subscriptions/123/providers/Microsoft.Authorization/roleDefinitions/234",
        ...
        },
        {
          ...
          "principalType": "User",
          "roleDefinitionId": "/subscriptions/123/providers/Microsoft.Authorization/roleDefinitions/456",
        ...
        },
        {
          ...
          "roleDefinitionId": "/subscriptions/123/providers/Microsoft.Authorization/roleDefinitions/345",
          "roleDefinitionName": "Blueprint Contributor",
          "scope": "/providers/Microsoft.Management/managementGroups/api_automations_group"
        }
      ]
    );
  }
...
Deno.test("when inputting a response with all types of assignment sources, they are properly converted from the 'scope' properties", async () => {
  ...
  await sut.loadTenantRoleAssignments(tenants);
  const expected: MeshTenantRoleAssignment[] = [
    {
      principalId: "dev_ops_team",
      principalName: "DevOps Team",
      principalType: MeshPrincipalType.Group,
      roleId: "/subscriptions/123/providers/Microsoft.Authorization/roleDefinitions/234",
      roleName: "Owner",
    ...
    },
    {
      ...
      roleId: "/subscriptions/123/providers/Microsoft.Authorization/roleDefinitions/456",
    ...
    },
    {
      ...
      roleId: "/subscriptions/123/providers/Microsoft.Authorization/roleDefinitions/345",
